...
SESSION_COOKIE_SAMESITE = config("SESSION_COOKIE_SAMESITE", default="None" if IS_PRODUCTION else "Lax")
CSRF_COOKIE_SAMESITE = config("CSRF_COOKIE_SAMESITE", default="None" if IS_PRODUCTION else "Lax")
